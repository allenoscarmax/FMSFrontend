    ...
    public partial class MainWindowViewModel : ObservableObject
    {
        ...
        private async Task UpperDoor(string storageId)
        {
            ...
            try
            {
                ...
                if (storageId == "0")
                {
                    if (!MagazinePara.MagazineParas[0].UpperScanEnable)
                    {
                        _windowService.ShowMessage("請啟動手臂執行掃描，完成後再開啟");
                        return;
                    }
                ...
                {
                    if (!MagazinePara.MagazineParas[1].UpperScanEnable)
                    {
                        _windowService.ShowMessage("請啟動手臂執行掃描，完成後再開啟");
                        return;
                    }
        ...
        private async Task LowerDoor(string storageId)
        {
            ...
            try
            {
                ...
                if (storageId == "0")
                {
                    if (!MagazinePara.MagazineParas[0].LowerScanEnable)
                    {
                        _windowService.ShowMessage("請啟動手臂執行掃描，完成後再開啟");
                        return;
                    }
                ...
                {
                    if (!MagazinePara.MagazineParas[1].LowerScanEnable)
                    {
                        _windowService.ShowMessage("請啟動手臂執行掃描，完成後再開啟");
                        return;
                    }
